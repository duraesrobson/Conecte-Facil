...
<div id="conteudoMain"></div> <!-- O conteúdo de pesquisa será exibido aqui -->
    ...
    <iframe width="560" height="315" src="https://www.youtube.com/embed/NHW5HGAzFxE?si=Y3mw73EQFO1QIjpN" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>
        </div>
        ...
        <div class="custom-content-section">
            <h3 class="custom-title">1. Acessar as Configurações</h3>
            <div class="custom-content-section">
            <ol class="custom-list">
            <li class="custom-item">Encontre o aplicativo de Configurações (ícone de engrenagem).</li>
            <li class="custom-item">Caso ele não esteja na tela principal, deslize a tela para cima para abrir a lista de aplicativos.</li>
            </ol>
            </div>

            <div class="custom-content-section">
            <h3 class="custom-title">2. Configurar o Wi-Fi</h3>
            <div class="custom-content-section">
            <ol class="custom-list">
            <li class="custom-item"><b>1:</b> Nas Configurações, clique em Rede e Internet.</li>
            <li class="custom-item"><b>2:</b> Selecione Wi-Fi para ver as redes disponíveis.</li>
            <li class="custom-item"><b>3:</b> Escolha a rede desejada e insira a senha fornecida (geralmente em estabelecimentos ou na sua casa).</li>
            <li class="custom-item"><b>4:</b> Após conectar, o telefone salva a senha para futuras conexões automáticas.</li>
            </ol>
            </div>

            <div class="custom-content-section">
            <h3 class="custom-title">3. Desligar o Wi-Fi para Economizar Bateria</h3>
            <div class="custom-content-section">
            <ol class="custom-list">
            <li class="custom-item">Se não houver Wi-Fi disponível, desligue o Wi-Fi indo em <b>Configurações > Wi-Fi</b> e desative a opção.</li>
            <li class="custom-item">Isso ajuda a economizar bateria quando você estiver em locais sem redes Wi-Fi.</li>
           </ol>
            </div>

            <div class="custom-content-section">
            <h3 class="custom-title">4. Usar Dados Móveis</h3>
            <div class="custom-content-section">
            <ol class="custom-list">
            <li class="custom-item">Quando estiver fora de casa, use a internet via Dados Móveis.</li>
            <li class="custom-item">Ative os dados móveis indo em <b>Configurações > Rede e Internet > Rede Móvel</b>.</li>
            <li class="custom-item">Isso permite o uso da internet em áreas externas, como parques ou praias.</li>
            </ol>
            </div>

            <div class="custom-content-section">
            <h3 class="custom-title">5. Atalhos Rápidos</h3>
            <div class="custom-content-section">
            <ol class="custom-list">
            <li class="custom-item">Acesse os atalhos arrastando o dedo para baixo a partir da parte superior da tela.</li>
            <li class="custom-item">Ali, você pode ativar ou desativar o Wi-Fi e os Dados Móveis rapidamente.</li>
            </ol>
            </div>

            <div class="custom-content-section">
            <h3 class="custom-title">6. Modo Avião</h3>
            <div class="custom-content-section">
            <ol class="custom-list">
            <li class="custom-item">Ative o Modo Avião nos atalhos rápidos ou em <b>Configurações > Rede e Internet > Avançado.</b></li>
            <li class="custom-item">O modo avião desativa todas as conexões (Wi-Fi e dados móveis), ideal para reuniões ou voos.</li>
            </ol>
            </div>
        ...
        <p>Agora você sabe como se conectar à internet via Wi-Fi ou Dados Móveis.
        <br>
        <br>
